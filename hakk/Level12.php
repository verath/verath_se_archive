...
if(!isset($_COOKIE["authorized-level-12"]))
{
	setcookie("authorized-level-12","no");
}
...
$curLevel=12; // Vilken level är det här?
...
// Om man har submittat.
	...
	if($_COOKIE["authorized-level-12"] == $password)
	{  
	// om lösen är rätt
...
$Error="Du är inte auktoriserad att komma till nästa level.";
