...
$curLevel=4; // Vilken level är det här?
...
// Om man har submittat.
	...
	$password="00992213"; // lösenordet är ...
...
$Error="Fel lösenord. Ett tips: <strong><a href=\"http://www.w3schools.com/tags/tag_input.asp\">Type=\"Hidden... Igen\"</a></strong>";
...
<p>Level 4.</p><br />
<!-- Så du ser dolda saker, du? Spooky :)... kanske kan du genomskåda den här nivån också?  -->
...
<form action="" method="get">
  <input type="hidden" value="http://verath.se/hakk/pass1.txt" name="PassFile" />
