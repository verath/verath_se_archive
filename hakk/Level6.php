...
$curLevel=6; // Vilken level är det här?
...
$Error="Fel lösenord. Ett tips: <strong><a href=\"http://www.w3schools.com/JS/js_variables.asp\">Javascript variabler</a> String+String</strong>";
...
<!-- ************************************************************************************************** -->
<!-- * THIS LEVEL IS PROTECTED BY "BETTER PROTECTION" copyright BetterJavaScriptProtectionAtVerath.se * -->
<!-- ************************************************************************************************** -->

<script language="javascript">
function checkPassword(inputedPass)
{
password="3"+"4";
