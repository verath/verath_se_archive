...
$curLevel=3; // Vilken level är det här?
...
$Error="Fel lösenord. Ett tips: <strong><a href=\"http://www.w3schools.com/tags/tag_input.asp\">Type=\"Hidden\"</a></strong>";
...
<p>Level 3.</p><br />
<!-- Har du kommit så här långt så kan du iaf kolla i källkoden, grattis!  -->
...
<form action="" method="get">
  <input type="hidden" value="kossa" name="The_Hidden_Field_That_Probably_Contains_The_Password_To_This_Level" />
