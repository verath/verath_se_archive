...
$curLevel=8; // Vilken level är det här?
...
$Error="Fel lösenord. Ett tips: <strong><a href=\"http://www.w3schools.com/js/js_whereto.asp\">Javascript External (långt ner)</a></strong>";
...
<!-- *********************************************************************************************************** -->
<!-- * THIS LEVEL IS PROTECTED BY "BETTER BEST PROTECTION" copyright BetterBestJavaScriptProtectionAtVerath.se * -->
<!-- *********************************************************************************************************** -->

<script language="javascript" src="Level8.js"></script>
